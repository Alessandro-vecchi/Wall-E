...
\centering
  \begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth, height = 5cm]{Left.jpg}
    \caption{Left motor Characterization}
    \label{fig:f1}
  \end{subfigure}
  \hspace{1cm}
  \begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth, height = 5cm]{Right.jpg}
...
\begin{figure}[hbp]
\centering
\includegraphics[width=0.4\textwidth]{ar.jpg}
...
\begin{figure}[hbp]
\centering
\includegraphics[width=0.4\textwidth, height = 3cm]{tr.jpg}
...
\centering
  ...
  \captionsetup{justification=centering}
    \includegraphics[width=4cm, height = 6cm]{red.jpg}
  ...
  \centering
  \captionsetup{justification=centering}
    \includegraphics[width=\textwidth, height = 6cm]{char.png}
...
\begin{figure}[hbp]
\centering
\includegraphics[width=0.4\textwidth, height = 4cm]{track.png}
...
\lstinputlisting[language=C++]{gift1.cpp}
...
\centering
  ...
  \centering
  \captionsetup{justification=centering}
    \includegraphics[width=\textwidth, height = 6cm]{pr1.jpg}
  ...
  \centering
  \captionsetup{justification=centering}
    \includegraphics[width=\textwidth, height = 6cm]{pr2.jpg}
